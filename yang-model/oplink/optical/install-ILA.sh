...
/usr/local/bin/sysrepocfg --import=openconfig-channel-monitor-startup-ILA.xml --datastore startup --module openconfig-channel-monitor; return_val
...
/usr/local/bin/sysrepocfg --import=openconfig-optical-attenuator-startup-ILA.xml --datastore startup --module openconfig-optical-attenuator; return_val
...
/usr/local/bin/sysrepocfg --import=openconfig-optical-amplifier-startup-ILA.xml --datastore startup --module openconfig-optical-amplifier; return_val
...
/usr/local/bin/sysrepocfg --import=com-oplink-optical-i-startup-ILA.xml --datastore startup --module com-oplink-optical-i; return_val

echo "###### install otdr"
/usr/local/bin/sysrepoctl -i openconfig-gnoi-otdr.yang -s ../common; return_val
/usr/local/bin/import_xml --import=openconfig-gnoi-otdr-startup-ILA.xml --datastore startup --module openconfig-gnoi-otdr; return_val
/usr/local/bin/sysrepoctl -i com-oplink-gnoi-otdr.yang -s ../common; return_val
/usr/local/bin/import_xml --import=com-oplink-gnoi-otdr-startup-ILA.xml --datastore startup --module com-oplink-gnoi-otdr; return_val
