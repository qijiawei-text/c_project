...
/usr/local/bin/import_xml --import=openconfig-channel-monitor-startup-DIABLO.xml --datastore startup --module openconfig-channel-monitor; return_val
...
/usr/local/bin/import_xml --import=openconfig-optical-attenuator-startup-DIABLO.xml --datastore startup --module openconfig-optical-attenuator; return_val
...
/usr/local/bin/import_xml --import=openconfig-optical-amplifier-startup-DIABLO.xml --datastore startup --module openconfig-optical-amplifier; return_val

echo "###### install control loop"
/usr/local/bin/sysrepoctl -i com-oplink-control-loop.yang -s ../common; return_val
/usr/local/bin/import_xml --import=com-oplink-control-loop-startup-1.xml --datastore startup --module com-oplink-control-loop; return_val

echo "###### install optical (otdr, mux)"
...
/usr/local/bin/sysrepoctl -i com-oplink-otdr.yang -s ../common; return_val
/usr/local/bin/import_xml --import=com-oplink-optical-startup-DIABLO.xml --datastore startup --module com-oplink-optical; return_val
/usr/local/bin/sysrepoctl -i com-oplink-connectivity-validation.yang -s ../common; return_val

/usr/local/bin/import_xml --import=com-oplink-optical-i-startup-DIABLO.xml --datastore startup --module com-oplink-optical-i; return_val
