...
extern void vme_out_string(const char *stringOut);
...
const char *
GetState(unsigned char a_ucState)
{
    switch ( a_ucState ) {
    case RESET:
        return "RESET";
...
void
PrintData(unsigned short a_iDataSize, unsigned char *a_pucData)
{
...
void
ispVMData(unsigned char *ByteData)
{
...
signed char
ispVMShift(signed char a_cCode)
{
...
signed char
ispVMLoop(unsigned short a_usLoopCount)
{
    signed char cRetCode = 0;
...
signed char
ispVMBitShift(signed char mode, unsigned short bits)
{
    unsigned short i = 0;
    unsigned short size = 0;
...
void
ispVMComment(unsigned short a_usCommentSize)
{
    char cCurByte = 0;
...
void
ispVMHeader(unsigned short a_usHeaderSize)
{
...
void
ispVMCalculateCRC32(unsigned char a_ucData)
{
...
signed char
ispVMLCOUNT(unsigned short a_usCountSize)
{
...
void
ispVMClocks(unsigned short Clocks)
{
...
void
ispVMBypass(signed char ScanType, unsigned short Bits)
{
...
void
ispVMStateMachine(signed char cNextJTAGState)
{
...
signed char
ispVMSend(unsigned short a_usiDataSize)
{
    unsigned short iIndex = 0;
...
signed char
ispVMRead(unsigned short a_usiDataSize)
{
    ...
    if ( usErrorCount > 0 ) {
        if ( g_usFlowControl & VERIFYUES ) {
            ...
            printf("VME_VERIFICATION_FAILURE\n");
...
signed char
ispVMReadandSave(unsigned short int a_usiDataSize)
{
...
signed char
ispVMProcessLVDS(unsigned short a_usLVDSCount)
{
