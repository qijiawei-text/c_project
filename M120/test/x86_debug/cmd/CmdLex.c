...
ULONG CMD_StringCmp(CHAR *pSrc, CHAR *pDst)
{
    CHAR c1,c2;
...
ULONG CMD_SortCompare(VOID *pD1, VOID *pD2)
{
...
ULONG CMD_SortBuffer(ULONG ulSes, ULONG ulCount)
{
...
ULONG CMD_DisPSortBuf(ULONG ulSes, ULONG ulCount)
{
    ULONG ulIndex;
    ULONG ulFlag = 0;
    CHAR  acTempBuf[100];
...
ULONG CMD_IsCanGroupOper(ULONG ulSes, CMD_CmdInfo* pstCurNode)
{
...
ULONG CMD_IfParaLegal(CMD_CmdInfo *pstNode, CHAR *pcPara)
{
    ULONG ulInteger;
...
VOID CMD_GetScrollMode(ULONG ulSes)
{
    for(;;)
    {
        CHAR acChar[1];
...
ULONG CMD_CheckQuotMark(ULONG ulSes)
{
    ULONG  ulIndex;
    ULONG  ulCount = 0;
...
CMD_CmdInfo *CMD_ScanTokens(ULONG ulSes, CMD_List *pstList, CHAR *pcName, ULONG *pulTimes)
{
    ULONG ulIndex;
    ULONG ulNameLen;
    ULONG ulMaxMatch = 0;
...
ULONG CMD_ExtendToken(ULONG ulSes, CMD_List *pstList, CHAR *pcToken)
{
    ULONG ulIndex;
    ULONG ulRet = 0;
...
CMD_CmdInfo* CMD_ScanDefTokens(ULONG ulSes, CMD_List *pstList, CHAR *pcName, ULONG *pulTimes)
{
    ULONG ulIndex;
    ULONG ulNameLen;
    ULONG ulMaxMatch;
...
ULONG CMD_ProcComTree(ULONG ulSession)
{
    ULONG ulType;
    ULONG ulIndex;
    ULONG ulTimes;
...
VOID CMD_SubmitCommand(ULONG ulSes)
{
    CHAR  cChar;
    ULONG ulIndex;
...
VOID CMD_FinishToken(ULONG ulSes)
{
    CHAR  cChar;
    ULONG ulIndex;
...
ULONG CMD_ProcDelete(ULONG ulSes)
{
    ULONG Quots;
    ULONG ulIndex;
...
ULONG CMD_ProcTabKey(ULONG ulSes)
{
...
ULONG CMD_ProcCtrlZ(ULONG ulSes)
{
    int iOpfd = 1;
...
ULONG CMD_ProcCtrlD(ULONG ulSes)
{
...
VOID CMD_EditSpecChar(ULONG ulSes, CHAR cChar)
{
    switch (cChar)
    {
    case '\b' :
...
ULONG CMD_IsNormalChar(CHAR cChar)
{
...
VOID CMD_LexProcess(ULONG ulSes)
{
    CHAR  cChar;
    ULONG ulCount;
    ULONG ulIndex;
