...
ULONG CMD_ReadCpld(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn    = 0;
    ULONG   ulStartAddr = 0;
    ULONG   ulReadLen = 0;
...
ULONG CMD_WriteCpld(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR    cReturn  = 0;
    ULONG   ulAddress = 0;
    UCHAR   ucVal  = 0;
...
ULONG CMD_ReadFanCpld(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn    = 0;
    ULONG   ulStartAddr = 0;
    ULONG   ulReadLen = 0;
...
ULONG CMD_WriteFanCpld(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn  = 0;
    ULONG   ulAddress = 0;
    UCHAR   ucVal  = 0;
...
ULONG CMD_ReadMdio(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    ULONG   ulPhyAddr = 0;
    ULONG   ulRegAddr = 0;
    ULONG   ulSes = atoi(argv[0]);
...
ULONG CMD_WriteMdio(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn  = 0;
    ULONG   ulPhyAddr = 0;
    ULONG   ulRegAddr = 0;
...
ULONG CMD_ReadMvSwitch(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    ULONG   ulPhyAddr = 0;
    ULONG   ulRegAddr = 0;
    ULONG   ulSes = atoi(argv[0]);
...
ULONG CMD_WriteMvSwitch(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn  = 0;
    ULONG   ulPhyAddr = 0;
    ULONG   ulRegAddr = 0;
...
ULONG CMD_MvInit(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn  = 0;
    ULONG   ulPhyAddr = 0;
    ULONG   ulRegAddr = 0;
...
ULONG CMD_ReadMvPhy(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    ULONG   ulDevAddr = 0;
    ULONG   ulPhyAddr = 0;
    ULONG   ulRegAddr = 0;
...
ULONG CMD_WriteMvPhy(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn  = 0;
    ULONG   ulDevAddr = 0;
    ULONG   ulPhyAddr = 0;
...
ULONG CMD_ReadMvXmdio(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    ULONG   ulPortNum = 0;
    ULONG   ulDevAddr = 0;
    ULONG   ulRegAddr = 0;
...
ULONG CMD_WriteMvXmdio(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn  = 0;
    ULONG   ulPortNum = 0;
    ULONG   ulDevAddr = 0;
...
ULONG CMD_ReadMvPagemdio(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    ULONG   ulPortNum = 0;
    ULONG   ulPageNum = 0;
    ULONG   ulRegAddr = 0;
...
ULONG CMD_WriteMvPagemdio(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn  = 0;
    ULONG   ulPortNum = 0;
    ULONG   ulPageNum = 0;
...
ULONG CMD_UsbSpiCom(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR    acBufWr[512] ={0};
    CHAR    acBufR[512]={0};
    INT     ICs    = 0;
...
ULONG CMD_JtagWriteCpld(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
...
ULONG CMD_JtagResetCpld(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR cReturn = 0;
    INT   iRet;
    INT   iBoardType = 0;
...
ULONG CMD_ReadSpiE1Flash(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn = 0;
    INT     iSourceFd = 0;
    INT     iRet = 0;
...
ULONG CMD_WriteSpiE1Flash(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR *pcFileName = NULL;
    CHAR cReturn = 0;
    INT   iSourceFd = 0;
...
ULONG CMD_SpiFlashEraseE1(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR cReturn = 0;
    ULONG ulSes    = atoi(argv[0]);
...
ULONG CMD_ReadSpiE2Flash(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn = 0;
    INT     iSourceFd = 0;
    INT     iRet = 0;
...
ULONG CMD_WriteSpiE2Flash(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR *pcFileName = NULL;
    CHAR cReturn = 0;
    INT   iSourceFd = 0;
...
ULONG CMD_SpiFlashEraseE2(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR cReturn = 0;
    ULONG ulSes    = atoi(argv[0]);
...
ULONG CMD_I350EEPROMWrite(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR *pcFileName = NULL;
    CHAR cReturn = 0;
    INT   iSourceFd = 0;
...
ULONG CMD_I350EEPROMRead(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn = 0;
    INT     iSourceFd = 0;
    INT     iRet = 0;
...
ULONG CMD_IICReadTemp(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR cReturn = 0;
    UCHAR ucTarget = 0;
    INT   iTemp;
...
ULONG CMD_IICReadEEPROM(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR  cReturn = 0;
    ULONG  ulAddr = 0;
    ULONG  ulLenRd = 0;
...
ULONG CMD_IICWriteEEPROM(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn = 0;
    ULONG   ulAddr = 0;
    ULONG   ulFileLen = 0;
...
ULONG CMD_IICReadEEPROMID(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR  cReturn = 0;
    ULONG  ulAddr = 0;
    ULONG  ulLenRd = 0;
...
ULONG CMD_IICWriteEEPROMID(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn = 0;
    ULONG   ulAddr = 0;
    ULONG   ulFileLen = 0;
...
ULONG CMD_IICReadEEPROMIDByCpld(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR  cReturn = 0;
    ULONG  ulAddr = 0;
    ULONG  ulLenRd = 0;
...
ULONG CMD_IICWriteEEPROMIDByCpld(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn = 0;
    ULONG   ulAddr = 0;
    ULONG   ulFileLen = 0;
...
ULONG CMD_IICReadEEPROMFanByCpld(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR  cReturn = 0;
    ULONG  ulAddr = 0;
    ULONG  ulLenRd = 0;
...
ULONG CMD_IICWriteEEPROMFanByCpld(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn = 0;
    ULONG   ulAddr = 0;
    ULONG   ulFileLen = 0;
...
ULONG CMD_IICReadPowerByCpld(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR  cReturn = 0;
    ULONG  ulAddr = 0;
    ULONG  ulLenRd = 0;
...
ULONG CMD_I2CCpldRead(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR  cReturn = 0;
    ULONG  ulAddr = 0;
    ULONG  ulLenRd = 0;
...
ULONG CMD_I2CCpldWrite(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn = 0;
    ULONG   ulAddr = 0;
    ULONG   ulFileLen = 0;
...
ULONG CMD_I2CCpldDebug1Read(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR  cReturn = 0;
    ULONG  ulAddr = 0;
    ULONG  ulLenRd = 0;
...
ULONG CMD_I2CCpldDebug1Write(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn = 0;
    ULONG   ulAddr = 0;
    ULONG   ulFileLen = 0;
...
ULONG CMD_I2CCpldDebug2Write(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    CHAR   cReturn = 0;
    ULONG   ulAddr = 0;
    ULONG   ulFileLen = 0;
...
ULONG CMD_PoeGetSoftVer(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    ULONG   ulSes = atoi(argv[0]);
...
ULONG CMD_DebugExceptOcm(ULONG ulSes, CHAR ucModIndex)
{
...
ULONG CMD_DebugToModule(ULONG ulSes, CHAR ucModIndex)
{
...
ULONG CMD_UartDebugMode(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    ULONG   ulSes = atoi(argv[0]);
    UCHAR ucModeIndex = 0;
    INT iRet = 0;
...
ULONG CMD_UartLoop1(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    ULONG   ulSes = atoi(argv[0]);
    ULONG  ulTimes = 0;
    INT iRet = 0;
...
ULONG CMD_UartLoop2(CHAR *pcBuf, INT Len, CHAR **argv, INT argc)
{
    ULONG   ulSes = atoi(argv[0]);
    ULONG  ulTimes = 0;
    INT iRet = 0;
