 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiLibInitialize(void); /* Should be called before
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiLibUnInitialize(void); /* Should be called before
                                          * program exit
                                          */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiBoardGetStringA(
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiBoardGetValue(
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiVgaGetBacklightEnable(
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiVgaSetBacklightEnable(
    __IN EApiId_t Id,         /* Backlight Id */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiVgaGetBacklightBrightness(
    __IN EApiId_t Id,         /* Backlight Id */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiVgaSetBacklightBrightness(
    __IN EApiId_t Id,         /* Backlight Id */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiStorageAreaRead(
    __IN EApiId_t Id,         /* Storage Area Id */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiStorageAreaWrite(
    __IN EApiId_t Id,         /* Storage Area Id */
    __IN uint32_t Offset,     /* Byte Offset */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiI2CGetBusCap(
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiI2CWriteReadRaw(
    __IN EApiId_t Id,             /* I2C Bus Id */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiI2CReadTransfer(
    __IN EApiId_t Id,         /* I2C Bus Id */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiI2CWriteTransfer(
    __IN EApiId_t Id,         /* I2C Bus Id */
    __IN uint32_t Addr,       /* Encoded 7/10Bit I2C
                               * Device Address
                               */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiI2CProbeDevice(
    __IN EApiId_t Id,      /* I2C Bus Id */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiWDogTrigger(void);
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiWDogStop(void);
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiGPIOGetDirectionCaps(
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiGPIOGetDirection(
    __IN EApiId_t Id,            /* GPIO Id */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiGPIOSetDirection(
    __IN EApiId_t Id,            /* GPIO Id */
    __IN uint32_t Bitmask,       /* Bit mask of Affected
                                  * Bits
                                  */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiGPIOGetLevel(
    __IN EApiId_t Id,            /* GPIO Id */
    __IN uint32_t Bitmask,       /* Bit mask of Affected
                                  * Bits
                                  */
 ...
 */
EApiStatus_t
EAPI_CALLTYPE EApiGPIOSetLevel(
    __IN EApiId_t Id,            /* GPIO Id */
    __IN uint32_t Bitmask,       /* Bit mask of Affected
                                  * Bits
                                  */
