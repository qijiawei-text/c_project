 ...
 *---------------------------------------------------------------------*/
PoE_Status_e
MSCC_POE_Init(Init_Info_t *ptMscc_InitInfo)
{
 ...
 *---------------------------------------------------------------------*/
PoE_Status_e
MSCC_POE_Clear_POE_Device_Buffer(U8 bIC_Address)
{
 ...
 *---------------------------------------------------------------------*/
PoE_Status_e
MSCC_POE_Msg(Protocol_15Bytes_Msg_Type_e eMessageType, _INOUT PoE_Msg_t *ptPoeMsg, U8 bIC_Address)
{
    PoE_Status_e ulResult = ePOE_STATUS_OK;
    PoE_Status_e ulTmplResult = ePOE_STATUS_OK;
 ...
 *---------------------------------------------------------------------*/
void
MSCC_POE_Get_Counters(_OUT Counters_t *ptCounters)
{
    if (ptCounters != NULL)
 ...
 *---------------------------------------------------------------------*/
PoE_Status_e
MSCC_POE_Firmware_Update(U8 bIC_Address, char S19FileName[])
{
    PoE_Status_e ulResult = ePOE_STATUS_OK;
    PoE_Status_e ulTmplResult = ePOE_STATUS_OK;
...
TransmitMsg(char *pcFunctionName, Protocol_15Bytes_Msg_Type_e eMsgType, _INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
...
/* 4.1.1 Reset Command   ****************************************************************/
TRANSMIT_MSG_STATUS_e
Reset_Command(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
...
TRANSMIT_MSG_STATUS_e
Restore_Factory_Defaults(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Save_System_Settings(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
/* 4.1.4 Set User Byte   ****************************************************************/
TRANSMIT_MSG_STATUS_e
Set_User_Byte(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bUserByte)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_System_Status(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bPrivate_Label)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_System_Status(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_System_Status2(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Interrupt_Mask(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, Protocol_interrupt_register_t tInterrutMaskRegister)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Interrupt_Mask(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Individual_Mask(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, Individual_Mask_e eINDV_MASK_OPT, POE_BOOL_e ePOE_BOOL_EnDis)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_System_OK_LED_Mask_Registers(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, Protocol_interrupt_register_t tBlink_Register, Protocol_interrupt_register_t tLight_Register)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_System_OK_LED_Mask_Registers(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Power_Indication_LED(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Software_Version(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_PoE_Device_Status(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCS_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Temporary_Matrix(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num, U8 bPhysical_Number_A, U8 bPhysical_Number_B)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Physical_Port_Number_from_Temporary_Matrix(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Program_Global_Matrix(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Physical_Port_Number_from_Active_Matrix(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
int
Process_Cmd_field(Feature_EnDis_Type_e eFeature_EnDis_Type, U8 byVal)
{
...
TRANSMIT_MSG_STATUS_e
Get_All_Ports_Enable_Disable(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Force_Power(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num, POE_BOOL_e ePOE_BOOL_EnDis)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Power_Limit_for_Channels(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num, U32 ulPPL_mW)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Temporary_Power_Limit_for_Channels(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num, U32 ulTPPL_mW)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Port_Power_Limit(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_4Pair_Port_Parameters(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address,
                          U8 bCh_Num,
                          Feature_EnDis_Type_e eFeature_EnDis_Type,
                          POE_BOOL_e ePOE_BOOL_Feature_EnDis,
                          U32 ulPPL4Pair_mW,
...
TRANSMIT_MSG_STATUS_e
Get_4Pair_Port_Parameters(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Power_Limits_for_4_Pair_Channels(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num, U32 ulPPL4Pair_mW)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Temporary_Power_Limits_for_4_Pair_Channels(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num, U32 ulTPPL4Pair_mW)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_4Pair_Port_Power_Limit(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Port_Priority(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num, Port_Priority_e ePortPriority)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Port_Priority(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Enable_Disable_4_Pair_for_Channels(
    _INOUT PoE_Msg_t *ptPoeMsg,
    U8 bI2C_Device_Address,
    U8 bCh_Num,
    Feature_EnDis_Type_e eFeature_EnDis_Type,
...
TRANSMIT_MSG_STATUS_e
Get_All_Ports_Enable_Disable_4pair(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Single_Port_Status(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_All_Ports_Status(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, Ports_Status_Group_e ePortsStatusGroup)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Extended_Port_Status(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Internal_Port_Status(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_UDL_Counters(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, UDL_Counter_Group_e eUDL_CounterGroup)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Detection_Failure_Counters(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, Detection_Counter_Group_e eDetCntGroup)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Latches(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, Latches_Group_e eLatchesGroup)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_global_port_counters(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, Counter_kind_e eCounter_kind, Counter_Group_e eCounter_Group)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_All_Ports_Class(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, Ports_Class_Group_e ePortsClassGroup)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_All_Ports_delivering_power_state(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Port_Event_Cause(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
/* 4.4.1 Set PM Method   ****************************************************************/
TRANSMIT_MSG_STATUS_e
Set_PM_Method(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address,
...
/* 4.4.2 Get PM Method   ****************************************************************/
TRANSMIT_MSG_STATUS_e
Get_PM_Method(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Total_Power(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Power_Banks(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address,
                U8 bBank,
                U32 ulPowerLimit_mW,
...
TRANSMIT_MSG_STATUS_e
Get_Power_Banks(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bBank)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Power_Supply_Parameters(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Power_Supply_Voltage(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_All_Ports_Power(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, Ports_Power_Group_e ePortsPowerGroup)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_All_4Pair_Ports_Power(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, Ports_4Pair_Power_Group_e ePorts4PairPowerGroup)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Port_Measurements(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_4Pair_Port_measurements(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Derating_Data(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bBank, U32 ulMax_PS_Power_mW, U32 ulTstart_mC, U32 ulTshutdown_mC, U32 ulDerating_Delta_Power_mW)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Derating_Data(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bBank)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Derating_User_Temperature(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U32 ulTemperature_mC)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Derating_User_Temperature(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_System_Measurements(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Port_Layer2_LLDP_PD_Data(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address,
                             U8 bCh_Num,
...
TRANSMIT_MSG_STATUS_e
Get_Port_Layer2_LLDP_PSE_Data(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Power_Bank_Power_Source_Type(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bBank, Power_Source_Type_e eMscc_PSE_power_source)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Get_Port_PowerUp_ALT_B(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Port_Layer2_CDP_PD_Data(_INOUT PoE_Msg_t *ptPoeMsg,
                            U8 bI2C_Device_Address,
                            U8 bCh_Num,
                            Set_Layer2_PD_Type_t tSet_Layer2_PD_Type,
...
TRANSMIT_MSG_STATUS_e
Get_Port_Layer2_CDP_PSE_Data(_INOUT PoE_Msg_t *ptPoeMsg, U8 bI2C_Device_Address, U8 bCh_Num)
{
    memset(ptPoeMsg, 0, sizeof(PoE_Msg_t));
...
TRANSMIT_MSG_STATUS_e
Set_Port_Layer2_CDP_PD_Data_2(_INOUT PoE_Msg_t *ptPoeMsg,
                              U8 bI2C_Device_Address,
                              U8 bCh_Num,
