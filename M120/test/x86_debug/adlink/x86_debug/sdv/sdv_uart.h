...
#define UART_TTY1                       ("/dev/ttyS1")
#define UART_TTY3                       ("/dev/ttyS3")
...
/**************************************************************************************************/
extern INT SDV_UartWrite(UCHAR ucModeIndex, CHAR *pcBuf, UINT nBufLen, UINT nRetry);
extern INT SDV_Uart0ReadCmdResp(UCHAR ucModeIndex, CHAR *pcBuf, UINT nBufLen, UINT nRetry);
extern INT SDV_UartWssReadCmdResp(UCHAR ucModeIndex, CHAR *pcBuf, UINT nBufLen, UINT nRetry);
extern INT SDV_UartRead(UCHAR ucModeIndex, CHAR *pcBuf, UINT nBufLen, UINT nRetry);
extern INT SDV_UartSetBaud(ULONG ulBaud);
extern INT SDV_UartBreak(UCHAR ucModeIndex);
extern INT SDV_UartInit(VOID);
extern INT SDV_UartClose(VOID);

extern INT SDV_UartLock(VOID);
extern INT SDV_UartUnLock(VOID);
