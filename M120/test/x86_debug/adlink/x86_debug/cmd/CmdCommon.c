...
ULONG
CMD_StrToInt(CHAR *pcSourcr, ULONG ulLen, ULONG *pulNum)
{
    CHAR cChar;
    ULONG ulIndex;
    ULONG ulResult = 0;
...
#define GX16                              0x11021
unsigned long
crc32(unsigned long crc, unsigned char *buf, int len)
{
...
VOID
CMD_DebugPrintf(CHAR *pcFilename, INT iLine, CHAR *pcStrInfo, ...)
{
