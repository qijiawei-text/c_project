...
VOID
CMD_SendData(ULONG ulFd, CHAR *pSendBuf, ULONG ulLen)
{
    INT i = 0;
...
ULONG
CMD_RecvData(ULONG ulFd, CHAR *pRecvBuf, ULONG ulLen)
{
    int lRead;
...
ULONG
CMD_GetUserName(ULONG ulSes, CHAR *pcBuf, ULONG ulLen)
{
    ULONG ulCount = 0;
...
ULONG
CMD_GetUserPWord(ULONG ulSes, CHAR *pcBuf, ULONG ulLen)
{
    ULONG ulCount = 0;
...
ULONG
CMD_GetSuperUserPWord(ULONG ulSes, CHAR *pcBuf, ULONG ulLen)
{
    ULONG ulCount = 0;
...
VOID
CMD_Entry(ULONG ulSes, ULONG ulIFd, ULONG ulOFd)
{
    int lRead;
