...
INT EESpiWriteOnePage(UINT unPageAddr,UCHAR *pucDataBuf,UINT unDataLen)
{
...
INT EESpiReadOnePage(UINT unPageAddr,UCHAR *pucDataBuf,UINT unDataLen)
{
    UCHAR ucDateTx[128] = {0};
    UCHAR ucDataRx[128] = {0};
