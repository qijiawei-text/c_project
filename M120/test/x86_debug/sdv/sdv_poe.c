...
int SDV_PoeIICWrite(U8 I2C_Address, const U8* Txdata, U16 num_write_length)
{
    SusiStatus_t status;
...
int SDV_PoeIICRead(U8 I2C_Address, _OUT U8* Rxdata, U16 number_of_bytes_to_read, _OUT U16 *number_of_bytes_actually_read, READ_MODE_e eReadMode)
{
    SusiStatus_t status;
    SusiId_t id = SUSI_ID_I2C_EXTERNAL;
    struct I2CConf config;
