 ...
 *              < ePOE_STATUS_OK - operation failed
 *---------------------------------------------------------------------*/
PoE_Status_e ePOE_COMMUNICATION_PROTOCOL_AnalysisAndExecutionCommand(Protocol_15Bytes_Msg_Type_e eMsgType, _INOUT PoE_Msg_t *ptPoeMsg, U8 bIC_Address)
{
	PoE_Status_e eResult;
 ...
 *              < ePOE_STATUS_OK               - operation failed
 *---------------------------------------------------------------------*/
PoE_Status_e poe_communication_protocol_wait_for_rx(U8 bIC_Address,	_OUT TX_REPLY_TYPE_e *eTxReplyType, U8 byEcho, U16 wCommandDelay_mSec)
{
 ...
 *---------------------------------------------------------------------*/
Port_Status_e GetActualPortsStatus(U8 bPortStatus)
{
