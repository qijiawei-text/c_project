...
S32 iRead_entire_file(char *sFile_name , char buffer[], S32 iFile_size)
{
...
U16 ClearLeadingZeroesFromData(U8 bRplyBuf[], U16 usRplySize , int iMaxBufferSize)
{
	S16 sStr_index = 0;
	S32 iBuf_index = 0;
...
int PrintBytesBuffer(const char* pcTitle, U8 byArrBuffer[], int iDataLen, int iMaxBufferSize)
{
	int i = 0;
 ...
 *---------------------------------------------------------------------*/
POE_BOOL_e iSerComm_verifyComm_with_poe(U8 byIC_Address, POE_BOOL_e *pePOE_BOOL_Is_system_status)
{
